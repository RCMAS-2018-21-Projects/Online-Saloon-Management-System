...
<div class="row" style="position:relative;width:600px;left:450px;top:50px;">
  <div class="col-75">
    ...
    <option value='12'>December</option>
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="password" id="cvv" name="cvv" placeholder="" id="pincode1"  inputmode="numeric" autocomplete="cc-number" autocompletetype="cc-number" x-autocompletetype="cc-number"
																		  placeholder="" pattern="^\d{3}$" title="Incorrect CVV" required>
              </div>
            </div>
          </div>
...
if(isset($_POST['amount'])){
   ...
   echo $pyid;
    ...
    $sql="update tbl_booking set status='paid' where bid='$pyid'";
   setDatas($sql);
