...
<div class="container">
			<div class="header_left">
				<ul>
					...
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <a href="mailto:info@example.com"></a></li>
				</ul>
			</div>
		<div class="header_right">
				<ul class="forms_right">
                <li><a href="my_book.php"> MY BOOKINGS</a> </li>
				</ul>
				...
				<div class="container">
					...
					<span class="icon-bar"></span>
						...
						<a class="navbar-brand" href="index.html">
							<h1><span class="fa fa-stethoscope" aria-hidden="true"></span>Magic<sub><font color=blue>Mirror</font></sub>  </h1>
						</a>
					</div>
					<!--/.navbar-header-->
							...
							<ul class="nav navbar-nav">
                               ...
                               <li class="dropdown">
									<a href="#" class="dropdown-toggle" data-toggle="dropdown">Booking <b class="caret"></b></a>
                                     <?php $sql="select scategory from addservice";
                                     $tbl=getDatas($sql);
                                     ?>
